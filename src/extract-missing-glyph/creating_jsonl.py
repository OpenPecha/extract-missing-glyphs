    ...
    for image_path in files_to_upload:
        if image_path.is_file():
            ...
            try:
                ...
                text = "_".join(image_path.stem.split('_')[:-1]) if '_' in image_path.stem else image_path.stem
...
def write_jsonl(final_jsonl, jsonl_base_path):
    ...
    # First half
    jsonl_path_1 = f"{jsonl_base_path}_variant_ga.jsonl"
    ...
    # Second half
    jsonl_path_2 = f"{jsonl_base_path}_variant_gb.jsonl"
